"""
@AUTHOR : https://github.com/rwightman/pytorch-image-models
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, block_args, num_classes=1000, num_features=1280, in_chans=3, stem_size=32,
        ...
        self.conv_head = create_conv2d(
            self._in_chs, self.num_features, 1, padding=pad_type)
    ...
    def as_sequential(self):
        ...
        layers.extend([nn.Flatten(), nn.Dropout(
            self.drop_rate), self.classifier])
...
class EfficientNetFeatures(nn.Module):
    ...
    def __init__(self, block_args, out_indices=(0, 1, 2, 3, 4), feature_location='bottleneck',
        ...
        self.blocks = nn.Sequential(*builder(self._in_chs, block_args))
        # builder provides info about feature channels for each block
        ...
        if _DEBUG:
            for k, v in self._feature_info.items():
                print('Feature idx: {}: Name: {}, Channels: {}'.format(
                    k, v['name'], v['num_chs']))
...
def _gen_fbnetc(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    arch_def = [
        ...
        ['ir_r1_k5_s2_e6_c32', 'ir_r1_k5_s1_e3_c32',
            'ir_r1_k5_s1_e6_c32', 'ir_r1_k3_s1_e6_c32'],
...
def _gen_mixnet_s(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    arch_def = [
        ...
        ['ir_r1_k3.5.7_s2_e6_c40_se0.5_nsw',
            'ir_r3_k3.5_a1.1_p1.1_s1_e6_c40_se0.5_nsw'],  # swish
        # stage 3, 28x28 in
        ['ir_r1_k3.5.7_p1.1_s2_e6_c80_se0.25_nsw',
            'ir_r2_k3.5_p1.1_s1_e6_c80_se0.25_nsw'],  # swish
        # stage 4, 14x14in
        ['ir_r1_k3.5.7_a1.1_p1.1_s1_e6_c120_se0.5_nsw',
            'ir_r2_k3.5.7.9_a1.1_p1.1_s1_e3_c120_se0.5_nsw'],  # swish
        # stage 5, 14x14in
        ['ir_r1_k3.5.7.9.11_s2_e6_c200_se0.5_nsw',
            'ir_r2_k3.5.7.9_p1.1_s1_e6_c200_se0.5_nsw'],  # swish
        # 7x7
    ]
    model_kwargs = dict(
        block_args=decode_arch_def(arch_def),
...
def _gen_mixnet_m(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, **kwargs):
    ...
    arch_def = [
        ...
        ['ir_r1_k3_s1_e6_c120_se0.5_nsw',
            'ir_r3_k3.5.7.9_a1.1_p1.1_s1_e3_c120_se0.5_nsw'],  # swish
        # stage 5, 14x14in
        ['ir_r1_k3.5.7.9_s2_e6_c200_se0.5_nsw',
            'ir_r3_k3.5.7.9_p1.1_s1_e6_c200_se0.5_nsw'],  # swish
        # 7x7
    ]
    model_kwargs = dict(
        block_args=decode_arch_def(
...
def semnasnet_050(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1('semnasnet_050', 0.5,
                            pretrained=pretrained, **kwargs)
    return model
...
def semnasnet_100(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1('semnasnet_100', 1.0,
                            pretrained=pretrained, **kwargs)
    return model
...
def semnasnet_140(pretrained=False, **kwargs):
    ...
    model = _gen_mnasnet_a1('semnasnet_140', 1.4,
                            pretrained=pretrained, **kwargs)
    return model
...
def mobilenetv2_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2('mobilenetv2_100', 1.0,
                              pretrained=pretrained, **kwargs)
    return model
...
def mobilenetv2_140(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2('mobilenetv2_140', 1.4,
                              pretrained=pretrained, **kwargs)
    return model
