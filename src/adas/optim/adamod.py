...
under the License.
@CREDIT: https://github.com/lancopku/AdaMod/blob/master/adamod/adamod.py
"""
import math
...
class AdaMod(Optimizer):
    ...
    It has been proposed in `Adaptive and Momental Bounds for
    Adaptive Learning Rate Methods`_.
    Arguments:
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                exp_avg, exp_avg_sq, exp_avg_lr = state['exp_avg'], \
                    state['exp_avg_sq'], state['exp_avg_lr']
